...
class node:
    ...
    def __init__(self,_nodeNum, _weights, _inputs, _outputs,_expectedOutput):
        self.inputs = _inputs
...
node7 = node(7,[0.98,0.35,0.5,0.9],[],[],[1,1,1,0,0,0])
nodelist.append(node7)
node8 = node(8,[0.92,0.8,0.13,0.8],[],[],[0,0,0,1,1,1])
